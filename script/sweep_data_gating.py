...
"""
===============================================================================
FIR 滤波器数据门控 (Data Gating) 多维度参数化扫描 CLI 入口
script/sweep_data_gating.py

调度 src/analysis/sweep_data_gating.py 执行 Tap Scale × Valid Duty × Data Activity
三维全物理后仿扫描。
===============================================================================
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Sky130 FIR 滤波器数据门控多维度参数化全物理扫描分析套件",
    ...
    parser.add_argument("--duties", nargs="+", type=int, default=[5, 20, 50, 80], help="要扫描的采样有效概率 (Valid Duty %%) 列表")
