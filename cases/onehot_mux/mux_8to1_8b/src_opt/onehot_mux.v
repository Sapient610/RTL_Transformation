// ==============================================================================
// 原生独热编码并行与或多路选择器 (Native One-Hot AND-OR Multiplexer) - 8-to-1 / 8-bit
// cases/onehot_mux/mux_8to1_8b/src_opt/onehot_mux.v
//
// 优化架构：
//   - 选择信号为 8-bit 原生独热码 (sel_onehot[7:0]，单有效高电平)
