// =============================================================================
// Transposed FIR Filter (Data Gated Architecture) - 12 Taps
// =============================================================================
module fir_top (
    input  wire                  clk,
    input  wire                  rst_n,
    ...
    localparam NUM_TAPS = 12;

    // 滤波器常数系数表
    localparam signed [7:0] COEFF_0 = 8'sd1;
    localparam signed [7:0] COEFF_1 = 8'sd4;
    localparam signed [7:0] COEFF_2 = 8'sd10;
    localparam signed [7:0] COEFF_3 = 8'sd22;
    localparam signed [7:0] COEFF_4 = 8'sd38;
    localparam signed [7:0] COEFF_5 = 8'sd53;
    localparam signed [7:0] COEFF_6 = 8'sd53;
    localparam signed [7:0] COEFF_7 = 8'sd38;
    localparam signed [7:0] COEFF_8 = 8'sd22;
    localparam signed [7:0] COEFF_9 = 8'sd10;
    localparam signed [7:0] COEFF_10 = 8'sd4;
    localparam signed [7:0] COEFF_11 = 8'sd1;

    // 数据门控逻辑：在采样无效 (data_valid == 0) 时将输入总线钳位为 0
    // 从而切断 sample_in 翻转广播向所有 12 个并行乘法器的传播
