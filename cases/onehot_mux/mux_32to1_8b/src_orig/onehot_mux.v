// ==============================================================================
// 纯二进制编码多路选择器 (Pure Binary-Coded Multiplexer) - 32-to-1 / 8-bit
// cases/onehot_mux/mux_32to1_8b/src_orig/onehot_mux.v
//
// 原始架构：
//   - 选择信号为标准 5-bit 二进制码 (sel[4:0])
//   - 综合工具自动构建 5 级级联平衡 MUX 树
